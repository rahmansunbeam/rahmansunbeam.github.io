import{s as n}from"./config-c9PVx6gu.js";const i=document.getElementById("certs-container"),s=document.getElementById("cert-modal"),d=document.getElementById("close-cert-modal"),c=document.getElementById("cert-modal-content"),m=l=>{const e=n.certifications[l];!e||!s||!c||(c.innerHTML=`
    <div class="space-y-6">
