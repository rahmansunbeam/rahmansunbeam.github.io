import{s as h}from"./config-DiWcn0BV.js";const c=document.getElementById("load-more-btn"),s=document.querySelectorAll(".project-item"),r=document.getElementById("project-modal"),g=document.getElementById("modal-content"),p=document.getElementById("close-modal");let n=5;const v=(l,e)=>{const t=document.createElement("div");if(t.className="fixed inset-0 bg-black bg-opacity-90 z-[60] flex items-center justify-center p-4",t.innerHTML=`
